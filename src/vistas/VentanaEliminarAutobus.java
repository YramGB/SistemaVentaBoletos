...
public class VentanaEliminarAutobus extends javax.swing.JFrame {

    public VentanaEliminarAutobus() {
        initComponents();
    ...
    private void initComponents() {
        ...
        eliminarBtn.setBackground(new java.awt.Color(236, 145, 117));
        eliminarBtn.setFont(new java.awt.Font("Agency FB", 0, 24)); // NOI18N
        ...
        jPanel1.add(eliminarBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(1110, 660, 130, 40));
        ...
        buscarComboBox.setForeground(new java.awt.Color(0, 0, 0));
    ...
    private void eliminarBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_eliminarBtnActionPerformed
        ...
        try{
            ...
            if(fila == -1){
                ...
                asiento.setNumeroAutobus(autobus.getNumeroAutobus());                                        
                for(int i = 1; i < 37; i++){
                    asiento.setNumeroAsiento(i);
                    admin.eliminarAsientos(asiento);
                }
                
                if(admin.eliminarAutobus(autobus)){                    
                    añadirBoletos();
                    JOptionPane.showMessageDialog(this, "Datos eliminados correctamente", "Autobus eliminado", JOptionPane.INFORMATION_MESSAGE);
                }else{
                    JOptionPane.showMessageDialog(this, "No se ha podido eliminar el autobus", "Boleto no eliminado", JOptionPane.ERROR_MESSAGE);
                }
            }            
        }catch(Exception e){
            JOptionPane.showMessageDialog(this, "No se ha seleccionado un boleto", "Boleto no seleccionado", JOptionPane.WARNING_MESSAGE);
        ...
        try{
            if(buscarComboBox.getSelectedItem().equals("Numero de autobus")){
                try{
                    ...
                    JOptionPane.showMessageDialog(this, "El valor ingresado debe ser un valor entero", "Formato de valor invalido", JOptionPane.ERROR_MESSAGE);
                }                
            ...
            JOptionPane.showMessageDialog(this, "Debe seleccionar una opción para buscar", "Error de selección", JOptionPane.WARNING_MESSAGE);      
        }    
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VentanaEliminarAutobus.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VentanaEliminarAutobus().setVisible(true);
            }
        });
    }
