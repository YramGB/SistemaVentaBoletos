...
public class VentanaModificarDescuento extends javax.swing.JFrame {

    public VentanaModificarDescuento() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel1.add(modificarDatosBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(940, 430, 130, 40));
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 360, 370, 290));

        tipoDescuentoLabel.setFont(new java.awt.Font("Agency FB", 0, 36)); // NOI18N
        tipoDescuentoLabel.setText("SELECCIONE EL DESCUENTO A MODIFICAR:");
        jPanel1.add(tipoDescuentoLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 260, -1, -1));
    ...
    private void modificarDatosBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_modificarDatosBtnActionPerformed
        ...
        try{
            if(fila == -1){
                ...
                VentanaModificarDatosDescuento editarDescuento = new VentanaModificarDatosDescuento(descuento);
                editarDescuento.setVisible(true);
                this.setVisible(false);
            }
        }catch(Exception e){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VentanaModificarDescuento.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VentanaModificarDescuento().setVisible(true);
            }
        });
    }
